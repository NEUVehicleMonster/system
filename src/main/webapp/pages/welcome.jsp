...
<nav class="navbar navbar-expand-lg navbar-dark pb_navbar pb_scrolled-light" id="pb-navbar">
    <div class="container">
        <a class="navbar-brand" href="index1.html">Law</a>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-end">
            <div class="col-md-6  order-md-1">
                ...
                <div class="sub-heading"><p class="mb-5">A free template by <a href="#">sc.chinaz.com</a> for Law Firm</p>
...
<section class="pb_section pb_section_v1" data-section="about" id="section-about">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="images">
                    <img class="img1 img-fluid" src="../images/600x450_img_2.jpg" alt="free Template by sc.chinaz.com">
                    <img class="img2" src="../images/800x500_img_1.jpg" alt="free Template by sc.chinaz.com">
                </div>
            </div>
    ...
    <div class="multiple-items pb_slide_v1">
        <div>
            <a href="#" class="link-block">
                <img src="../images/1900x1200_img_4.jpg" alt="" class="img-fluid">
        ...
        <div>
            <a href="#" class="link-block">
                <img src="../images/1900x1200_img_2.jpg" alt="" class="img-fluid">
                <div class="slide-text">
                    <h2>Migration Law</h2>
                    <span>Read More</span>
                </div>
        ...
        <div>
            <a href="#" class="link-block">
                <img src="../images/1900x1200_img_3.jpg" alt="" class="img-fluid">
                <div class="slide-text">
                    <h2>Civil Rights</h2>
                    <span>Read More</span>
                </div>
        ...
        <div>
            <a href="#" class="link-block">
                <img src="../images/1900x1200_img_1.jpg" alt="" class="img-fluid">
                <div class="slide-text">
                    <h2>Civil Rights</h2>
                    <span>Read More</span>
                </div>
                ...
                <div class="single-item pb_slide_v2">
                    <div>
                        <div class="d-lg-flex d-md-block slide_content">
                            <div class="pb_content-media" style="background-image: url(../images/1900x1200_img_4.jpg);"></div>
                    ...
                    <div>
                        <div class="d-lg-flex d-md-block slide_content">
                            <div class="pb_content-media" style="background-image: url(../images/1900x1200_img_2.jpg);"></div>
                            <div class="slide_content-text text-center">
                    ...
                    <div>
                        <div class="d-lg-flex d-md-block slide_content">
                            <div class="pb_content-media" style="background-image: url(../images/1900x1200_img_3.jpg);"></div>
                            <div class="slide_content-text text-center">
        ...
        <div class="row">
            <div class="col-md">
                <div class="card text-center pb_card_v1 mb-4">
                    <img class="card-img-top rounded-circle w-50 mx-auto" src="../images/square_img_5.jpg" alt="Card image cap">
                    <div class="card-body">
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-10 col-sm-12 mb-5">
                <div class="single-item-no-arrow pb_slide_v1">
                    <div>
                        <div class="media">
                            <img class="d-flex img-fluid rounded-circle mb-sm-5" src="../images/square_img_5.jpg" alt="Generic placeholder image">
                            <div class="media-body pl-md-5 pl-sm-0">
                                <blockquote>
                                    <p>&ldquo;Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.&rdquo;</p>
                                    <p class="pb_author"><citeclass="text-uppercase">John Smith</cite> Designer at sc.chinaz.com</p>
                                </blockquote>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body pl-md-5 pl-sm-0">
                                <blockquote>
                                    ...
                                    <p class="pb_author"><cite class="text-uppercase">John Smith</cite> Designer at sc.chinaz.com</p>
                                </blockquote>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col text-center">
                <p class="pb_font-14">Copyright &copy; 2018.Company name All rights reserved.<a target="_blank" href="http://www.cssmoban.com/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
            </div>
        </div>
    </div>
</footer>
