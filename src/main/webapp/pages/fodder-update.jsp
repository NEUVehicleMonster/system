...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 正文区域 -->
        <form action="${pageContext.request.contextPath}/fodder/updateById.do"
              method="post">
            <!-- 正文区域 -->
                ...
                <div class="panel panel-default box box-primary">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-10 data">
                            <input type="hidden" name="id" value="${fodder.id}">
                            <input type="text" class="form-control" name="node"
                                   placeholder="NodeCode" value="${fodder.node}">
                        </div>
                        <div class="col-md-2 title">饲料名称</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="name"
                                   placeholder="品牌" value="${fodder.name}">
                        </div>

                        <div class="col-md-2 title">余量</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="total"
                                   placeholder="斤" value="${fodder.total}">
                        ...
                        <div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" placeholder="配料详情"
                                      name="info" >${fodder.info}</textarea>
                        </div>
