    ...
    <div class="content-wrapper">
        ...
        <section class="content"> <!-- .box-body -->
            <div class="box box-primary">
                ...
                <form action="${pageContext.request.contextPath}/user/dropByIds.do" method="post">
                    <div class="box-body">
                                ...
                                <c:forEach items="${pageInfo.list}" var="user">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${user.id}" class="btn bg-blue btn-xs">添加角色</a>
                                            <c:if test="${user.status==1}">
                                            <a  onclick="location.href='${pageContext.request.contextPath}/user/dropByIds.do?ids=${user.id}'" class="btn bg-red btn-xs">停用</a>
                                            </c:if>
                                            <c:if test="${user.status==0}">
                                                <a  onclick="location.href='${pageContext.request.contextPath}/user/enabledByIds.do?ids=${user.id}'" class="btn bg-black btn-xs">启用</a>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
